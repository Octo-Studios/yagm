...
import it.hurts.sskirillss.yagm.client.particle.type.GhostlyFogParticleType;
...
public class ParticleRegistry {
    ...
    public static final RegistrySupplier<ParticleType<GhostlyFogParticleOptions>> GHOSTLY_FOG = PARTICLE_TYPES.register("ghostly_fog", GhostlyFogParticleType::new);
